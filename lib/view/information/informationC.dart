...
class InformationC extends StatefulWidget {
  @override
  InformationCState createState() => InformationCState();
}

class InformationCState extends State<InformationC> {
  int currentStep = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("خطوات التقديم للفئة - C",style: TextStyle(
            color: Colors.black,
            fontFamily: "cairo"
        ),),
        centerTitle: true,

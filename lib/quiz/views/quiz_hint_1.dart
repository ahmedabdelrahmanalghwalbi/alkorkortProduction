...
class QuizHint1 extends StatefulWidget {
  var id,title,description;
  QuizHint1({this.id,this.title,this.description});

  @override
  _QuizHint1State createState() => _QuizHint1State();
}

class _QuizHint1State extends State<QuizHint1> {
  bool isArabic=true;
  getIsArabic()async{

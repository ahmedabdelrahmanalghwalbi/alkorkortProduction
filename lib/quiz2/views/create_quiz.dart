...
import 'package:korkort/quiz2/views/add_question.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("(Gör ett test C) عمل أخبتار للفئة c",style: TextStyle(
          color: Colors.white,
          fontFamily: "cairo"
        ),),
...
//                ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      hintText: "(Beskrivning av testet) وصف الأختبار",
                    hintStyle: TextStyle(
                        fontFamily: "cairo"
                    ),
                    border: OutlineInputBorder(

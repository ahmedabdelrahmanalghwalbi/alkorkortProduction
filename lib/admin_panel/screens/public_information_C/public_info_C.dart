...
class PublicInformationC extends StatefulWidget {
  @override
  _PublicInformationCState createState() => _PublicInformationCState();
}

class _PublicInformationCState extends State<PublicInformationC> {
  String title;
  String description;
  ...
  createSign()async{
    await FirebaseFirestore.instance.collection("PublicInformationC").add({
      'title':title,
      'imageUrl':uploadedImageUrl,
      'description':description,
    }).then((value){print("^^^^^^^^^^^^^^^^^^^ public Information C stored successfully");}).catchError((ex){
      print("^^^^^^^^^^^^^^^^^^^^^^^^^^^^ failed to store public Information C");
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("(Allmän information C) المعلومات العامة للفئة C"),
          centerTitle: true,
        ),
                            ...
                            child: Card(
                              child: ListTile(
                                ...
                                leading: GestureDetector(
                                  ...
                                  onTap: ()async{
                                    await FirebaseFirestore.instance.collection("PublicInformationC").doc(document.id).delete().then((value){
                                      print("xxxxxxxxxxxxxxxxxxxxxxxxxx public information C deleted successfullt");
                                    });
                                    setState(() {});
                                  },
                                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text('وصف المعلومة (Beskrivning av informationen)',style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontFamily: 'cairo'
                        ),),
                        SizedBox(height: 5,),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child:Text("حفظ المعلومة (Bevara informationen)",style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold
                            ),)
                        ),
          ...
          child: Container(
            child: Column(
              children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                                hintText: "(Ange informationen) أدخل العنوان",
                                border: OutlineInputBorder(
                                    borderSide: BorderSide(
                                        color: Colors.blueAccent
                                    )
                ...
                //get and deleting public information C
                Container(
                  height: MediaQuery.of(context).size.height,
                  child: FutureBuilder(
                    future:FirebaseFirestore.instance.collection("PublicInformationC").get(),
                                ...
                                child: Card(
                                  child: ListTile(
                                    ...
                                    leading: GestureDetector(
                                      ...
                                      onTap: ()async{
                                        await FirebaseFirestore.instance.collection("PublicInformationC").doc(document.id).delete().then((value){
                                          print("xxxxxxxxxxxxxxxxxx public information C deleted successfullt");
                                        });
                                        setState(() {});
                                      },
                                    ),
